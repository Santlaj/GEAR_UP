...
_HIERARCHY: dict[str, list[str]] = {
    ...
    "health_supplements_protein": ["food", "pre_packaged_food", "packaged_commodity", "all"],
    "health_supplements": ["food", "pre_packaged_food", "packaged_commodity", "all"],
    "spices_condiments": ["spices", "food", "pre_packaged_food", "packaged_commodity", "all"],
    "nuts_dry_fruits": ["nuts", "dry_fruits", "food", "pre_packaged_food", "packaged_commodity", "all"],
...
_ALIASES: dict[str, str] = {
    ...
    "health_supplements_protein": "health_supplements_protein",
    "spices_condiments": "spices",
    "nuts_dry_fruits": "dry_fruits",
    "oats": "cereals",
    "oat": "cereals",
    "rolled oats": "cereals",
    ...
    "macaroni": "pasta",
    "noodles": "noodles",
    "peanut butter": "health_supplements_protein",
    "peanut_butter": "health_supplements_protein",
    "nut butter": "health_supplements_protein",
    "protein powder": "health_supplements_protein",
    "whey protein": "health_supplements_protein",
    "food supplement": "health_supplements_protein",
    "food supplements": "health_supplements_protein",
    "health supplement": "health_supplements_protein",
    "dietary supplement": "health_supplements_protein",
    ...
    # --- Stable machine-readable category IDs ---
    "food_savoury_snacks": "namkeen",
    "food_biscuits": "biscuits",
    "food_bread": "bread",
    "food_rice": "rice",
    "food_flour": "flour",
    "food_cereals_pulses": "cereals",
    "food_edible_oil": "edible_oil",
    "food_tea": "tea",
    "food_coffee": "coffee",
    "food_beverage": "soft_drinks",
    "food_packaged_water": "packaged_water",
    "food_baby_food": "baby_food",
    "food_milk_products": "milk_products",
    "food_sweets_confectionery": "sweets",
    "food_salt": "salt",
    "food_spices": "spices",
    "food_general": "food",
    "personal_care_soap": "soap",
    "household_detergent": "detergent",
    "personal_care_cosmetic": "cosmetics",
    "industrial_cement": "cement",
    "industrial_paint": "paint",
    "non_food_general": "non_food",
    "packaged_commodity_general": "packaged_commodity",
}
...
def resolve_ancestors(canonical: str) -> list[str]:
    ...
    if canonical in _HIERARCHY:
        ...
        if canonical != "packaged_commodity":
            chain.append("packaged_commodity")
        chain.append("all")
    return chain
